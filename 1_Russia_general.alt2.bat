...
--filter-tcp=443 --hostlist="%~dp0lists\hosts.txt" --dpi-desync=split2 --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern="%~dp0build\main-build\tls_clienthello_www_google_com.bin"
